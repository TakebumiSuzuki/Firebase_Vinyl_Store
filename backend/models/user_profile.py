...
class UserProfile(db.Model):
    ...
    user_name: Mapped[str|None] = mapped_column(db.String(50))
    ...
    def __repr__(self):
        return f'<UserProfile uid:{self.uid} user_name:"{self.user_name}" is_admin:{self.is_admin} email:{self.email} birthday:{self.birthday} favorite_color:{self.favorite_color} >'
